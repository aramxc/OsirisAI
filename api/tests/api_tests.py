...
# This is a basic suite of API tests for the endpoints we have so far. This will be used to help teach others about SDET related job responsibilities.
# We are using Playwright for testing. Playwright is a Node.js library to
